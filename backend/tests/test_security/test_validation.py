...
class TestInputSanitizer:
    ...
    def test_validate_password_strength_strong_password(self):
        ...
        strong_password = "StrongP@ssw0rd!42"
    ...
    def test_sanitize_json_input(self):
        ...
        # Check that the javascript: protocol was removed from the nested value
        assert not sanitized["nested"]["value"].startswith("javascript:")
